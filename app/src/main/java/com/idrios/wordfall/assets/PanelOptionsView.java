...
public class PanelOptionsView extends PanelView{
    ...
    public PanelOptionsView(Context context){
        this(context, null);
    }
    public PanelOptionsView(Context context, AttributeSet attributeSet){
    ...
    public static PanelOptionsView fromXml(Context context, ViewGroup parent){
        return (PanelOptionsView) LayoutInflater.from(context).inflate(R.layout.view_panel_options, parent, false);
    }
